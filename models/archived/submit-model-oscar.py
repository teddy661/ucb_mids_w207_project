...
train_df = pd.read_csv(TEST_CSV, encoding="utf8")
...
results_df.index += 1
results_df.to_csv("test_results_oscar.csv", index=False, encoding="utf-8")
...
submission_df.to_csv("submission-oscar.csv", index=False, encoding="utf-8")
